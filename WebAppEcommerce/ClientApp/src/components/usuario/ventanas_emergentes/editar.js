            ...
            >
                ...
                <Modal.Body>
                    <Form onSubmit={this.EditUserSubmit} >
                        ...
                        <Form.Row sm={10}>
                            <Form.Group as={Col} >
                                <Form.Control type="text" name="Nombres" value={this.state.usuario.Nombres} maxLength={15} className="pz-input" onChange={this.InputChange} placeholder="Primer nombre" />
                            </Form.Group>
                            <Form.Group as={Col} >
                                <Form.Control type="text" name="Apellidos" value={this.state.usuario.Apellidos} maxLength={15} className="pz-input" onChange={this.InputChange} placeholder="Segundo nombre" />
                            </Form.Group>
                        </Form.Row>
