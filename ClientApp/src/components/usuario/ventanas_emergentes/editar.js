...
class EditarUsuario extends Component {
    ...
    componentDidMount() {
        console.log(this.props.id_usuario_seleccionado);
        this.props.cargar_editar_usuario(this.props.id_usuario_seleccionado, this);
    ...
    render() {
        ...
        const { init_editar_usuario} = this.props;
            ...
            >
                ...
                <Modal.Body>
                    <Form onSubmit={this.EditUserSubmit} >
                        ...
                        <Form.Row sm={10}>
                            <Form.Group as={Col} >
                                <Form.Control type="text" name="PrimerNombre" value={this.state.usuario.PrimerNombre} maxLength={15} className="pz-input" onChange={this.InputChange} placeholder="Primer nombre" />
                            </Form.Group>
                            <Form.Group as={Col} >
                                <Form.Control type="text" name="SegundoNombre" value={this.state.usuario.SegundoNombre} maxLength={15} className="pz-input" onChange={this.InputChange} placeholder="Segundo nombre" />
                            </Form.Group>
                        </Form.Row>
                        <Form.Row sm={10}>
                            <Form.Group as={Col} >
                                <Form.Control type="text" name="PrimerApellido" value={this.state.usuario.PrimerApellido} maxLength={15} className="pz-input" onChange={this.InputChange} placeholder="Primer apellido" />
                            </Form.Group>
                            <Form.Group as={Col} >
                                <Form.Control type="text" name="SegundoApellido" value={this.state.usuario.SegundoApellido} maxLength={15} className="pz-input" onChange={this.InputChange} placeholder="Segundo apellido" />
                            </Form.Group>
                        </Form.Row>
                        <Form.Row sm={10}>
...
function mapStateToProps(state) {
    const { loggingIn, user, mostrar_crear_usuario, init_crear_usuario, init_editar_usuario, usuario_actualizado, id_usuario_seleccionado} = state.authentication;
    return { loggingIn, user, mostrar_crear_usuario, init_crear_usuario, init_editar_usuario, usuario_actualizado, id_usuario_seleccionado };
};
