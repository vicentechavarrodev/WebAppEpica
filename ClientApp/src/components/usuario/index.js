...
class Usuario extends Component {
    ...
    constructor(props) {
        ...
        this.searchOptions = {
            fields: ['Codigo', 'NombreCompleto','NombreEmpresa'],
            operator: 'contains'
        };
    ...
    created(args) {
        document.getElementsByClassName("e-search")[0].getElementsByClassName("e-input")[0].setAttribute("placeholder", "Buscar por Código, Nombre o Empresa")
    } 
                ...
                <div className='wrap-form table-responsive container-fluid'>
                    <GridComponent dataSource={usuarios} ref={this.grid} rowDeselected={this.rowDeselected} rowSelected={this.rowSelected} toolbar={this.toolbarOptions} searchSettings={this.searchOptions} created={this.created.bind(this)} >
                        <ColumnsDirective>
                            ...
                            <ColumnDirective field='NombreCompleto' width='200'  headerText='Nombre'  />
                            ...
                            <ColumnDirective field='NombreEmpresa' headerText='Empresa' width='200'  />
                            <ColumnDirective field='NombreSede' headerText='Sede' width='150' />
                        </ColumnsDirective>
